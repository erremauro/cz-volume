...
- Aligned `CZ_VOLUME_VERSION` and `CZ_VOLUME_DB_VERSION` constants with plugin header.

## [1.4.1] 2026-04-16
### Add
- Add the 'Mostra Come' metabox to allow alternative chapter's title in single volume view.  

## [1.4.0] 2026-02-25
### Add
- Aggiunge i pulsanti 'Visualizza Volume' e 'Modifica Volume' alla sezione 'Gestione Capitoli'
### Changed
- Sostituisce 'Numero Capitolo' con 'Indice Capitolo' rendendolo un campo testuale.

## [1.3.1] 2026-02-14
### Add
- Aggiunge il pulsante 'Gestisci Volume' dalla Modifica Volume
